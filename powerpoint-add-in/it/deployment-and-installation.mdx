...
<Info>
Starting with the 2025 release, Grunt ships as a self-contained .NET 9 COM add-in. It no longer requires the VSTO Runtime or .NET Framework on the target machine. If you are upgrading from the previous .NET Framework 4.7.2 version, see [Upgrading from .NET Framework](/powerpoint-add-in/it/upgrading-from-dotnet-framework) for migration details.
</Info>
