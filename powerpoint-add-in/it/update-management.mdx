...
1. Download the approved installer from [app.grunt.pro/download](https://app.grunt.pro/download).
...
Legacy support guidance describes three channels:
...
The legacy guidance also states that Grunt typically aims for about four stable releases per year, with occasional hotfixes when needed.
