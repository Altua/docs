...
Do not remove the legacy domains yet. Grunt supports both endpoint sets during the transition.

The legacy domains will eventually be discontinued. We will notify you before you can remove them from your network configuration.
...
Use your organization's standard allowlist process for all Grunt domains listed above.

Allow both the current and legacy Grunt endpoints during the transition.
