...
When working with files synced through OneDrive, Grunt may not always detect changes automatically after you save in Excel. This depends on how OneDrive handles file synchronization on your machine.
...
Grunt uses the same file access permissions as your Windows account. If you do not have access to the linked Excel file, Grunt cannot read it or notify you of changes — even if someone else with access has updated the file.
