...
If a Visual Grid stops responding to clicks and no menus appear (while other grids on the same slide work normally), restart PowerPoint. This is typically caused by a temporary selection state issue.

If the problem recurs, collect logs and contact support.
