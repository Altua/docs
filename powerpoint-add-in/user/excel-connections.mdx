...
## Automate updates with VBA

On Windows, you can update a Grunt chart or table from an Excel macro. The macro passes an Excel range to the PowerPoint add-in and targets the Grunt object by its PowerPoint shape name.

See [Automate Excel updates with VBA](/powerpoint-add-in/user/vba-automation) for setup steps, sample code, and error handling.
